...
**Due: Sunday, November 02, 11:59pm CDT**
...
You can try out the [instructor's implementation](https://CS-4388-5388-Fall-2025.github.io/Assignments/Assignment-4/dist) in the Builds repository on the course GitHub.
...
**Step 1:** Create your private repository using the following link: https://classroom.github.com/a/2ef9WBxN

**Step 2:** Your repository will be added to the [GitHub course organization](https://github.com/CS-4388-Fall-2025).  You will need to open your repository on GitHub, then go to Settings->Pages and change the build and deployment source to `GitHub Actions`, as shown in the image below.  You **must** complete this step or you will not be able to to deploy the finished assignment.
